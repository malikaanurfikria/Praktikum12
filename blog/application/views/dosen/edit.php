...
<?php echo form_open("dosen/save") ?>
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nidn" name="nidn" placeholder="Masukkan nidn" type="text" value="<?= $obj_dosen->nidn?> " class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="gender" name="gender" placeholder="Masukkan gender" type="text" value="<?= $obj_dosen->gender?> " class="form-control">
    </div>
  </div>
  <div class="form-group row">
